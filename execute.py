...
#   for x in range(20):
#     x = randint(1, 7000)
#     print("./nsp ./NSPLib/Cases/{1}.gen ./NSPLib/N{0}/{2}.nsp 10000 {3} >> N{0}-{3}-{4}.txt".format(nurses,case,x,retries,name))
#     os.system("./nsp ./NSPLib/Cases/{1}.gen ./NSPLib/N{0}/{2}.nsp 10000 {3} >> N{0}-{3}-{4}.txt".format(nurses,case,x,retries,name)) 
